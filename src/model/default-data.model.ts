...
export class DefaultData{
    ...
    get(table:string){
        ...
        switch(table){
            case 'categories':
                ret= [
                    {id:1, parent:0, name:'Characteristics and Surroundings',	title:'Characteristics and Surroundings',	description: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', selected:false},
                    {id:2, parent:0, name:'Facility Exterior',	                title:'Facility Exterior',          	    description: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', selected:false},
                    {id:3, parent:0, name:'Facility Interior',	                title:'Facility Interior',	                description: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', selected:false},
                    {id:4, parent:0, name:'Security Policies, Procedures and ',	title:'Security Policies, Procedures and ',	description: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', selected:false},
                    {id:5, parent:0, name:'Policy COnsiderations',	            title:'Policy Considerations',	            description: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', selected:false},
                    {id:6, parent:2, name:'Fencing and Walls',	                title:'Fencing and Walls',	                description: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', selected:false},
                    {id:7, parent:2, name:'Gates',	                            title:'Gates',	                            description: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', selected:false},
                    {id:8, parent:2, name:'Lighting',	                        title:'Lighting',	                        description: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', selected:false},
                    {id:9, parent:2, name:'Building and Grounds',	            title:'Building and Grounds',               description: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', selected:false},
                    {id:10,parent:2	,name:'Landscaping',	                    title:'Landscaping',	                    description: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', selected:false},
                    {id:11,parent:0	,name:'Transportation Areas',	            title:'Transportation Areas',	            description: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', selected:false},
                    {id:12,parent:1	,name:'Staff Parking Areas',	            title:'Staff Parking Areas',	            description: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', selected:false},
                    {id:13,parent:11,name:'Visitor Parking Areas',	            title:'Visitor Parking Areas',	            description: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', selected:false},
                    {id:14,parent:11,name:'Student Parking',	                title:'Student Parking',	                description: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', selected:false}
                ];
            break;
